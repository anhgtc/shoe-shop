...
<body>
    <section class="h-full gradient-form bg-gray-200 md:h-auto">
                            ...
                            <div class="lg:w-6/12 px-4 md:px-0">
                                <div class="md:p-12 md:mx-6">
                                    ...
                                    <form method="POST" action="{{ route('signin') }}">
                                        @csrf
                                        <p class="mb-4 text-2xl">Đăng nhập</p>
                                        @if($errors->has('email'))
                                        ...
                                        <div class="mb-4">
                                            <input type="password" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="password" name="password" placeholder="Password" required />
                                        </div>
